...
**[Read the Bootstrap CSS Grid docs](https://getbootstrap.com/docs/5.0/layout/css-grid/)** for more info.

## Offcanvas in navbars

<a href="https://getbootstrap.com/docs/5.0/components/navbar/#offcanvas">
...
**[Head to the placeholder docs](https://getbootstrap.com/docs/5.0/components/placeholders/)** to learn more.

## Horizontal collapse

Hot damn, we've finally added official support for [horizontally collapsing](https://twbs-bootstrap.netlify.app/docs/5.0/components/collapse/#horizontal)! The collapse plugin has been able to detect `width` vs `height` for some time (even in v4), but we never had a working example in our docs until now. Add the `.collapse-horizontal` modifier class to transition the `width` instead of `height` and set a `width` on the immediate child element.
...
Learn more in the **[stacks helper docs](https://getbootstrap.com/docs/5.0/helpers/stacks/)**.
...
Like all our other `:root` CSS variables, the values for these are [generated from our Sass variables](https://getbootstrap.com/docs/5.0/content/reboot/#css-variables). That means that matter how you customize Bootstrap—via Sass or CSS variables—you haven't lost any functionality or convenience.

**[Read the CSS variables customization docs](https://getbootstrap.com/docs/5.0/customize/css-variables/)** for more info.
...
- [Footers](https://getbootstrap.com/docs/5.0/examples/footers/)
- [Dropdowns](https://getbootstrap.com/docs/5.0/examples/dropdowns/)
- [List groups](https://getbootstrap.com/docs/5.0/examples/list-groups/)
- [Modals](https://getbootstrap.com/docs/5.0/examples/modals/)

**[Explore all our examples](https://getbootstrap.com/docs/5.0/examples/)** to see more.
