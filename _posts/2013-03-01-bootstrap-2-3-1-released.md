...
While Bootstrap 2.3 was the last planned release ahead of 3.0, we've just pushed out a small patch to address a few lingering JavaScript bugs. [Bootstrap 3](https://github.com/twitter/bootstrap/pull/6342) is still under development and is trucking along quite nicely. We'll have more to share there soon.
...
Check out the [2.3.1 pull request](https://github.com/twitter/bootstrap/pull/7111) for more details on the changes in this release.

<a class="btn-link" href="https://github.com/twitter/bootstrap/zipball/master">Download Bootstrap 2.3.1</a> <span class="muted">(latest master ZIP)</span>
