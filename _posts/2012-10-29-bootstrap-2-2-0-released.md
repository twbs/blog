...
For the full list of issues included in this release, visit the [2.2.0 milestone on GitHub](https://github.com/twitter/bootstrap/issues?milestone=15&page=1&state=closed). Otherwise, be sure to **[visit the docs](http://getbootstrap.com)** or **[download today](https://github.com/twitter/bootstrap/zipball/master)** to get your hands on 2.2.0.
