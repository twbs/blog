...
Bootstrap 4 will move to Long Term Support after we release `v4.4` and will no longer receive new features from than on. It will continue to receive bug fixes, security updates, and documentation updates.
