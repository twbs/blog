...
- **Fixed:** Silence bad selectors in our plugins for `href` attribute to avoid JavaScript errors. Try to use [valid selectors](https://www.w3.org/TR/CSS21/syndata.html#value-def-identifier), or the `data-target` attribute when available.
